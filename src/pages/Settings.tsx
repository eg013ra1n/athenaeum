        ...
        <>
          ...
          <div className="bg-surface-elevated rounded-lg p-6 space-y-6">
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <div>
                      ...
                      <span className="block text-xs text-content-muted mt-1">
                        When enabled, Athenaeum checks for a newer version each time it starts and
                        shows a notification if one is available. Disable to only check manually via
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <div>
                      ...
                      <span className="block text-xs text-content-muted mt-1">
                        When enabled, the update checker will also look for pre-release (beta)
                        versions. Beta builds may contain new features that are still being tested.
                      </span>
                    </div>
                  </label>
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-content-muted mt-2">
                    Frames within this angular distance will be grouped together. Current value:{' '}
                    {getThresholdInDegrees()}° (decimal degrees)
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-content-muted mt-2">
                    ...
                    sessions can span midnight (e.g., 19:00 Day 1 → 03:00 Day 2 = one night).
                    Default is 6 hours.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="text-xs text-content-muted mb-4">
                Defaults for the per-flat contour plot rendered in Blink (toolbar mountain icon).
                Values match PixInsight's <span className="font-mono">FlatContourPlot</span> v1.3.1
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-content-muted mt-2">
                    Master switch. When off, no scan roots are polled even if individually marked as
                    "Monitor". New files are still picked up on manual scan.
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-content-muted mt-2">
                    How often to re-scan each monitor-enabled folder for new files. The scanner is
                    idempotent, so short intervals are fine on local drives but may be costly for
                    large NAS directories. Default is 10 minutes.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-content-muted mb-3">
                When enabled, new unclustered light frames that fall within the grouping threshold
                of an existing frame set are automatically attached to that set. Every merge is
                recorded in the frame set's History tab so you can audit what the algorithm did.
              ...
              <div className="space-y-3">
                <label className="flex items-start gap-2 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-content-muted mt-0.5">
                      When on, clicking the button merges all candidates immediately without showing
                      a preview dialog.
                    </p>
                  </div>
                </label>
                <label className="flex items-start gap-2 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-content-muted mt-0.5">
                      When on, background scans that discover new lights automatically attach them
                      to the nearest matching frame set (within the grouping threshold) without user
                      intervention. You'll see a toast + notification bell entry for each
                      auto-merge.
                    </p>
                  </div>
                </label>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-content-muted mt-2">
                    Resolution for blink viewer images. Thumbnail is fastest, Preview balances speed
                    and quality, Full shows maximum detail. Note: Changing this will cache images
                    separately for each resolution.
                  </p>
                  {blinkResolution === 'full' && (
                    <p className="text-xs text-warning mt-2">
                      Full resolution debayers one-shot-colour frames at their native resolution
                      with gradient interpolation — around ten times slower per frame than Preview,
                      and four times the pixels. Buffering a whole set will take noticeably longer.
                    </p>
                  )}
                </div>
                ...
                {blinkResolution === 'thumbnail' && (
                  <div>
                    ...
                    <p className="text-xs text-content-muted mt-2">
                      JPEG quality for thumbnail images. Default: 70. Lower values = smaller files,
                      faster loading.
                    </p>
                  </div>
                )}
                ...
                {blinkResolution === 'preview' && (
                  <div>
                    ...
                    <p className="text-xs text-content-muted mt-2">
                      JPEG quality for preview/blink viewer images. Default: 85. Good balance of
                ...
                {blinkResolution === 'full' && (
                  <div>
                    ...
                    <p className="text-xs text-content-muted mt-2">
                      JPEG quality for full resolution images. Default: 95. Highest quality for
                      detailed viewing.
                    </p>
                  </div>
                )}
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-content-muted mt-2">
                    Number of concurrent image processing threads (1–{blinkThreadsMax}). Lower
                    values use less memory, higher values process faster.
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-content-muted mt-2">
                    Maximum number of images kept in the memory cache. Default: 200. For large frame
                    sets, increase this to avoid cache thrashing. A preview image is well under a
                    megabyte; a full-resolution colour one is much larger, which is what the limit
                    below is for.
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-content-muted mt-2">
                    Total memory the image cache may use, whichever limit is reached first. Default:
                    512 MB. Image size varies enormously with resolution, so the image count alone
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-content-muted mt-2">
                    Cached images are automatically evicted after this many minutes of inactivity.
                    Default: 30. Max: 1440 (24 hours). Accessing an image resets its timer.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        setAnnotationSettings(prev => ({ ...prev, color_scheme: e.target.value }))
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setAnnotationSettings(prev => ({
                          ...prev,
                          ecc_good: parseFloat(e.target.value) || 0.5,
                        }))
                      }
                      min="0"
                      max="1"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setAnnotationSettings(prev => ({
                          ...prev,
                          ecc_warn: parseFloat(e.target.value) || 0.6,
                        }))
                      }
                      min="0"
                      max="1"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setAnnotationSettings(prev => ({
                          ...prev,
                          fwhm_good: parseFloat(e.target.value) || 1.3,
                        }))
                      }
                      min="0.5"
                      max="5"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setAnnotationSettings(prev => ({
                          ...prev,
                          fwhm_warn: parseFloat(e.target.value) || 2.0,
                        }))
                      }
                      min="0.5"
                      max="10"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setAnnotationSettings(prev => ({
                          ...prev,
                          ellipse_scale: parseFloat(e.target.value) || 1.2,
                        }))
                      }
                      min="0.5"
                      max="4"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setAnnotationSettings(prev => ({
                          ...prev,
                          min_radius: parseFloat(e.target.value) || 6,
                        }))
                      }
                      min="1"
                      max="30"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setAnnotationSettings(prev => ({
                          ...prev,
                          max_radius: parseFloat(e.target.value) || 60,
                        }))
                      }
                      min="10"
                      max="200"
            ...
            <div>
              ...
              <div className="p-4 bg-surface rounded-lg border border-border space-y-3">
                <p className="text-xs text-content-muted">
                  A sampled content hash of every catalogued file — the first, middle and last 512
                  KB, about 1.5 MB of reading per file. It has two uses: skipping files the other
                  device already has when transferring, and grouping the Duplicates view by content
                  when the option below is on. It is built in the background as a job of its own,
                  never during a scan: automatically after each scan when sync is set up or content
                  grouping is on, and by hand from the button here or on the Folders page. A running
                  job can be stopped from the job card in the sidebar.
                </p>
                ...
                {!contentIndex.running && contentIndex.lastFinished && (
                  <p
                    className={`text-xs ${contentIndex.lastFinished.failed ? 'text-warning' : 'text-content-muted'}`}
                  >
                ...
                <label className="flex items-start gap-3 cursor-pointer pt-1">
                  ...
                  <div>
                    ...
                    <span className="block text-xs text-content-muted mt-1">
                      ...
                      already records: no extra reading, and copies still match after a move between
                      drives changed their timestamps. Masters and processed files are compared by
                      their full contents.
                    </span>
                    <span className="block text-xs text-content-muted mt-1">
                      <span className="font-semibold text-content-secondary">On</span> — everything,
                      masters included, is grouped by the sampled hash: 1.5 MB of each file, so two
                      masters that differ only outside the sampled regions look identical. Run a
                      deep verify before deleting masters in this mode.
                    </span>
                    <span className="block text-xs text-content-muted mt-1">
                ...
                {contentIndex.status &&
                  !contentIndex.status.syncConfigured &&
                  !useContentHash &&
                  contentIndex.status.pending > 0 && (
                    <p className="text-xs text-content-muted">
          ...
          <div className="mt-6 bg-surface-elevated rounded-lg p-6">
            ...
            <p className="text-xs text-content-muted mb-4">
              Manage destination folders for archives in{' '}
              <span className="text-content">File Manager → Archive Folders</span>.
            </p>
            <div>
              <label className="block text-sm font-medium text-content-secondary mb-2">
                Compression
              ...
              >
                <option value="store">
                  Store (no compression — fastest, archive size ≈ source size)
                </option>
                <option value="deflate">
                  Deflate (smaller, slower — marginal savings on raw FITS)
                </option>
              </select>
              <p className="text-xs text-content-muted mt-2">
          ...
          {isTauri && (
            <div className="mt-6 bg-surface-elevated rounded-lg p-6">
              ...
              <p className="text-sm text-content-muted mb-4">
                Where Athenaeum stores its catalog database and log files on disk. Click the folder
                icon to reveal the database in your file manager, or to open the log folder
                directly.
              </p>
              <div className="bg-surface-secondary rounded p-4 text-sm font-mono space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-content truncate flex-1" title={dbPath || undefined}>
                    {dbPath || '—'}
                  </span>
                  {dbPath && <FileLocationActions compact paths={[dbPath]} />}
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-content-muted min-w-[80px]">Log folder:</span>
                  <span className="text-content truncate flex-1" title={logDir || undefined}>
                    {logDir || '—'}
                  </span>
                  {logDir && <FileLocationActions compact directories paths={[logDir]} />}
                </div>
              </div>
            </div>
          )}
          ...
          <div className="mt-6 bg-surface-elevated rounded-lg p-6">
            ...
            <p className="text-xs text-content-muted mb-4">
              Controls what gets written to the JSONL log file{isTauri ? ' shown above' : ''}. Debug
              is verbose — useful while diagnosing an issue, not recommended to leave on
              permanently.
            </p>
            <LoggingSettings />
          </div>
