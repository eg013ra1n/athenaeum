...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_effective_exposure_frame_ids,
            commands::get_exposure_version_review,
            commands::confirm_exposure_version_link,
            commands::unlink_exposure_version,
            commands::set_processing_stage,
            ...
            commands::list_terminal_transfers,
            ...
            commands::get_transfer_paths,
            commands::set_transfer_paths,
            commands::cleanup_transfer_leftovers,
