...
| 3 | **Manual calibration assignment** (item 6): scoring first, then the unified modal — CORE DONE 2026-09-05 (spec `docs/superpowers/specs/2026-09-05-calibration-scoring-design.md`), the unified modal is the second pass | architectural → spec → plan |
