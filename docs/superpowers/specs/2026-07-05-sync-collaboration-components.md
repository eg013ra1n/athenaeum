...
| D-8 | Collab delivery = **hub as tracker + members as swarm**: package-level announcements + have-reports on hub, any receive-role holder serves; store-and-forward deferred to Phase IV paid tier | accepted (owner, 2026-07-06 — collab design §2) |
